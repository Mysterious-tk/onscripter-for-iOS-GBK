...
SDL_GLContext UIKit_GL_CreateContext(_THIS, SDL_Window * window)
{
    ...
    CGRect frameRect;
    if(!soi.isIpad)
	frameRect = CGRectMake(0.0, 0.0, 480, 320);
    else frameRect = CGRectMake(0.0, 0.0, 1024, 768);
	 data->landscapeView = [[UIView alloc] initWithFrame: frameRect];
	CGAffineTransform tr = data->landscapeView.transform; 
	...
	fprintf(stderr, "the scallar is %f\n",gLandscapeView.contentScaleFactor);
	return view;
}
