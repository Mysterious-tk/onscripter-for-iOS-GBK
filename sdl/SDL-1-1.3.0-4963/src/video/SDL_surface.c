                     ...
                     Uint32 Rmask, Uint32 Gmask, Uint32 Bmask, Uint32 Amask)
{
    ...
    if (surface->format->BitsPerPixel <= 8) {
        //fprintf(stderr, "is printing palette");
        SDL_Palette *palette =
     ...
     //   fprintf(stderr, "fist palette is avilable .. at %d\n",surface->format->palette);
       // fprintf(stderr, "fist surface is avilable .. at %d\n",surface);
    ...
    surface->refcount = 1;
   // fprintf(stderr, "second palette is avilable .. at %d\n",surface->format->palette);
  //  fprintf(stderr, "second surface is avilable .. at %d\n",surface);
    surface->backPale = surface->format->palette;
